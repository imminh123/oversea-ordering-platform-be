...
import { SearchItemDto, SearchItemDtoV2 } from './tabao.dto';
...
export class TaobaoController {
  ...
  clientIndexAddress(@Query() searchDto: SearchItemDtoV2) {
    return this.taobaoService.directSearchItemTaobaoV2(searchDto);
  }
